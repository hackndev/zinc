...
pub mod reg {
  ...
  ioreg!(RCCReg: CR, PLLCFGR, CFGR, CIR, AHB1RSTR, AHB2RSTR, AHB3RSTR,
  ...
  reg_rw!(RCCReg, CR,         set_CR,         CR)
  reg_rw!(RCCReg, PLLCFGR,    set_PLLCFGR,    PLLCFGR)
  reg_rw!(RCCReg, CFGR,       set_CFGR,       CFGR)
  reg_rw!(RCCReg, CIR,        set_CIR,        CIR)
  reg_rw!(RCCReg, AHB1RSTR,   set_AHB1RSTR,   AHB1RSTR)
  reg_rw!(RCCReg, AHB2RSTR,   set_AHB2RSTR,   AHB2RSTR)
  reg_rw!(RCCReg, AHB3RSTR,   set_AHB3RSTR,   AHB3RSTR)
  reg_rw!(RCCReg, APB1RSTR,   set_APB1RSTR,   APB1RSTR)
  reg_rw!(RCCReg, APB2RSTR,   set_APB2RSTR,   APB2RSTR)
  reg_rw!(RCCReg, AHB1ENR,    set_AHB1ENR,    AHB1ENR)
  reg_rw!(RCCReg, AHB2ENR,    set_AHB2ENR,    AHB2ENR)
  reg_rw!(RCCReg, AHB3ENR,    set_AHB3ENR,    AHB3ENR)
  reg_rw!(RCCReg, APB1ENR,    set_APB1ENR,    APB1ENR)
  reg_rw!(RCCReg, APB2ENR,    set_APB2ENR,    APB2ENR)
  reg_rw!(RCCReg, AHB1LPENR,  set_AHB1LPENR,  AHB1LPENR)
  reg_rw!(RCCReg, AHB2LPENR,  set_AHB2LPENR,  AHB2LPENR)
  reg_rw!(RCCReg, AHB3LPENR,  set_AHB3LPENR,  AHB3LPENR)
  reg_rw!(RCCReg, APB1LPENR,  set_APB1LPENR,  APB1LPENR)
  reg_rw!(RCCReg, APB2LPENR,  set_APB2LPENR,  APB2LPENR)
  reg_rw!(RCCReg, BDCR,       set_BDCR,       BDCR)
  reg_rw!(RCCReg, CSR,        set_CSR,        CSR)
  reg_rw!(RCCReg, SSCGR,      set_SSCGR,      SSCGR)
  reg_rw!(RCCReg, PLLI2SCFGR, set_PLLI2SCFGR, PLLI2SCFGR)

  ioreg!(FLASHReg: ACR, KEYR, OPTKEYR, SR, CR, OPTCR)
  reg_rw!(FLASHReg, ACR,   set_ACR,     ACR)
  reg_w!(FLASHReg,         set_KEYR,    KEYR)
  reg_w!(FLASHReg,         set_OPTKEYR, OPTKEYR)
  reg_rw!(FLASHReg, SR,    set_SR,      SR)
  reg_rw!(FLASHReg, CR,    set_CR,      CR)
  reg_rw!(FLASHReg, OPTCR, set_OPTCR,   OPTCR)

  ioreg!(PWRReg: CR, CSR)
  reg_rw!(PWRReg, CR,  set_CR,  CR)
  reg_rw!(PWRReg, CSR, set_CSR, CSR)
